...
xfce4-terminal --geometry 70x10-0-0 -T 'zrtva3' -e "bash -c 'himage zrtva3 nc -kul -p svn';bash" &
xfce4-terminal --geometry 70x10+0-250 -T 'bot1' -e "bash -c 'himage BOT1 /bot 10.0.0.10 5555';bash" &
xfce4-terminal --geometry 70x10+0-0 -T 'bot2' -e "bash -c 'himage BOT2 /bot 10.0.0.10 5555';bash" &
